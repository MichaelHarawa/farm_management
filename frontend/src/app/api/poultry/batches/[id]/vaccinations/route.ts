...
import type { PoultryVaccination } from "@/features/poultry/types";
...
export async function POST(request: NextRequest, { params }: RouteContext) {
  ...
  try {
    const vaccination = await routeAuthenticatedBackendFetch<PoultryVaccination>(
      request,
      poultryApiPaths.vaccinations(batchId),
      {
        method: "POST",
