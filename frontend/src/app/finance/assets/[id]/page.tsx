...
export default async function AssetDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return <FinancePageShell eyebrow="Finance / Asset lifecycle" title={asset.name} detail={`${asset.asset_code} · ${formatLabel(asset.status)}`} actions={<BackLink href="/finance/assets">Asset register</BackLink>}>
